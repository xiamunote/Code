...
public partial class backwork_UpDateFlight : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        SqlCommand scd = new SqlCommand("delete from FlightInformation  where id=" + id, ts);
        scd.ExecuteNonQuery();
    ...
    protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Response.Redirect("UpDateStock.aspx?id=" + id + "");
    }
